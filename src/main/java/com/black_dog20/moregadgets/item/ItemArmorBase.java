...
public class ItemArmorBase extends ItemArmor implements IItemModelRegister{

	public ItemArmorBase(String name, ArmorMaterial armor, int renderIndex, EntityEquipmentSlot slot) {
		super(armor, renderIndex, slot);
